...
#include <centauro_horizon/WBTrajectory.h>
...
private:
    ...
    void mpc_joint_callback(const centauro_horizon::WBTrajectoryConstPtr msg);
    ...
    centauro_horizon::WBTrajectory _mpc_solution, _old_solution;
